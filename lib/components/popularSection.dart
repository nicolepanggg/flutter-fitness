...
import '../models/viewModel/PopularViewModel.dart';
import '../styles/app_styles.dart'; // AppStyles

class PopularSection extends StatelessWidget {
  final List<PopularViewModel> popularDiets;
  const PopularSection({super.key, required this.popularDiets});
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemBuilder: (context, index) {
            if (!popularDiets[index].isVisible()) {
